...
onMounted(async () => {
  ...
  // Carrega lavouras e sugestões em paralelo
  ...
  // Em modo edição, carrega dados da cotação
  if (isEditing.value && quotationId) {
    // Busca dentro dos grupos (não tem endpoint individual, busca nos grupos)
...
// Filtro de sugestões pelo que foi digitado
...
<template>
  <div class="quotation-form">
    ...
    <h1 class="quotation-form__title">
